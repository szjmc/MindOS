...
class RecallCardPreviewModal extends Modal {
  ...
  onOpen() {
    ...
    const relatedContainer = contentEl.createDiv({ cls: "mindos-card-manager-related" });
    ...
    const closeBtn = btnRow.createEl("button", { cls: "mindos-btn mindos-btn-md mindos-btn-primary" });
    closeBtn.setText("关闭");
